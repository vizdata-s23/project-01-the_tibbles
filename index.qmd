...
Our approach to the first question involved the visualization of geographic information in four ways. The first way involved creating a scatter plot of Bigfoot sightings overlayed on a map of the mainland United States. This would allow us to directly observe clusters of sightings and areas of relative absence. The second way is by creating a heat map of Bigfoot sightings overlayed on a map of the mainland United States. A heat map trades the precision of directly mapping all sightings for the advantage of a clear representation of density. When Bigfoot sightings are common in a region, they overlap when plotted individually. The heatmap aggregates these sightings into a common grid space which lights up brightly, easily identifying the hotspot. In both approaches, the plots were faceted by decade so that we could make comparisons across time.

The third and fourth approach to answering the first question involved the use of stacked bar graphs to track the proportion of Bigfoot sightings, by decade, recorded in each region of the country. We used a stack bar graph to visualize how the distribution among regions changes over time. Although the exact proportion for a region is slightly more difficult to determine in a stacked bar graph, the density of data is much greater than for a conventional bar plot that might display the regions in sperate colums. We chose to graph proportions and not nominal counts, because the focus of our research question is not the quantity of sightings, but rather the overall changes in the distribution as a whole. Additionally, since some decades produced dramatically more sightings (in our dataset) than others, it may have been near impossible to clearly observe trends in the less-populated decades of our data. Lastly, we decided to use regions instead of states as 50 invididual colors would be difficult to read, trading precision for clarity. 
