...
1.  How has the geographic distribution of Bigfoot sightings changed over time?
    ...
    -   Use a bar plot to count the number of sighting in each state, facet this graph by year. This visualization will show which states have the most Bigfoot sightings and how that changes over time.
2.  Are certain weather conditions more commonly associated with Bigfoot sightings than others?
