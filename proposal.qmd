...
2.  Are certain weather conditions more commonly associated with Bigfoot sightings than others?
    -   Create a plot the illustrating the distribution of Bigfoot sightings with respect to 'cloud_cover', 'moon_phase', 'precip_intensity', 'precip_type', and 'visibility'
